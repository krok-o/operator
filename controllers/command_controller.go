...
//+kubebuilder:rbac:groups=delivery.krok.app,resources=commands,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=delivery.krok.app,resources=commands/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=delivery.krok.app,resources=commands/finalizers,verbs=update
