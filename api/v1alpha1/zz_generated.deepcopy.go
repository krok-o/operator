...
func (in *KrokCommandSpec) DeepCopyInto(out *KrokCommandSpec) {
	*out = *in
	if in.ReadInputFromSecrets != nil {
		in, out := &in.ReadInputFromSecrets, &out.ReadInputFromSecrets
		*out = make([]Ref, len(*in))
		copy(*out, *in)
	}
	if in.Platforms != nil {
...
func (in *KrokEventSpec) DeepCopyInto(out *KrokEventSpec) {
	*out = *in
	if in.CommandsToRun != nil {
		in, out := &in.CommandsToRun, &out.CommandsToRun
		*out = make([]CommandTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KrokEventStatus) DeepCopyInto(out *KrokEventStatus) {
	*out = *in
	if in.FailedCommands != nil {
		in, out := &in.FailedCommands, &out.FailedCommands
		*out = make(CommandList, len(*in))
		copy(*out, *in)
	}
	if in.SucceededCommands != nil {
		in, out := &in.SucceededCommands, &out.SucceededCommands
		*out = make(CommandList, len(*in))
		copy(*out, *in)
	}
	if in.RunningCommands != nil {
		in, out := &in.RunningCommands, &out.RunningCommands
